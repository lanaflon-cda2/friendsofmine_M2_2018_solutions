...
public class ActiviteServiceIntegrationTest {
    ...
    public void testFindAllActiviteFromDataLoaderAreSortedByTitre() {
        ...
        assertTrue("les éléments 6 et 7 de la liste sont bien triés",
                (activites.get(6).getTitre()).compareTo(activites.get(7).getTitre()) < 0);
        assertTrue("les éléments 7 et 8 de la liste sont bien triés",
                (activites.get(7).getTitre()).compareTo(activites.get(8).getTitre()) < 0);
        assertTrue("les éléments 8 et 9 de la liste sont bien triés",
                (activites.get(8).getTitre()).compareTo(activites.get(9).getTitre()) < 0);
    }
